...
class Item(models.Model):
    ...
    notesDetails = models.TextField(null=True, blank=True)
    ...
    fontSize = models.CharField(max_length=255, null=True, blank=True)
    fontStyle = models.CharField(max_length=255, null=True, blank=True)
    fontWeight = models.CharField(max_length=255, null=True, blank=True)
